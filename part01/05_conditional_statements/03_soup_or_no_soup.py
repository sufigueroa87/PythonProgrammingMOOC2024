...
#                                                ' for the number of portions and prints out the total cost. The price '
#                                                'of a single portion is 5.90.)
#
...
if name != "Jerry":
    numberOfPortions = int(input("How many portions of soup? "))
    print(f"The total cost is {priceOfPortion * numberOfPortions}")
    print("Next please!")
else:
    print("Next please!")
